...
Contact.view = function () {
    return m(
        ...
        m(
            ...
            m(
                'div',
                { className: 'contact__item--email item', onclick: Contact.vm.showClipMessage.bind(Contact.vm.showClipMessage, 'email'), 'data-clipboard-text': 'justinnsullivan@gmail.com' },
                m('img', { className: 'contact__icon--email' })
            ),
            m(
                'div',
                { className: 'contact__item--phone item', onclick: Contact.vm.showClipMessage.bind(Contact.vm.showClipMessage, 'number'), 'data-clipboard-text': '9088121119' },
                m('img', { className: 'contact__icon--phone' })
            ),
            m(
                'div',
                { className: 'contact__item--github item', onclick: Contact.vm.showClipMessage.bind(Contact.vm.showClipMessage, 'Github'), 'data-clipboard-text': 'https://github.com/justinnsullivan' },
                m('img', { className: 'contact__icon--github' })
            ),
            m(
                'div',
                { className: 'contact__item--linkedin item', onclick: Contact.vm.showClipMessage.bind(Contact.vm.showClipMessage, 'Linkedin'), 'data-clipboard-text': 'https://www.linkedin.com/in/justin-sullivan-4a929889' },
...
Hamburger.view = function (ctrl, options) {
    return m('div', {
        onclick: ctrl.click,
        class: 'hamburger'
    }, [m('span', { class: 'hamburger__line one' }), m('span', { class: 'hamburger__line twoA' }), m('span', { class: 'hamburger__line twoB' }), m('span', { class: 'hamburger__line three' })]);
};
...
var Responses = function Responses(resps) {
